        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12 px-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
              AI-Powered Resume <span className="bg-gradient-to-r from-blue-700 to-blue-900 bg-clip-text text-transparent">Analyzer</span>
            </h1>
          ...
          {/* Main Card */}
          <div className="bg-gray-50 rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 mb-8 sm:mb-10 border border-gray-300">
...
• Any specific requirements"
            ...
            {/* Error Message */}
            {error && (
              <div className="mb-6 sm:mb-8 p-4 sm:p-5 bg-red-50 border border-red-200 rounded-xl sm:rounded-2xl flex items-start gap-3 sm:gap-4">
                <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 text-red-600 mt-0.5 flex-shrink-0" />
                <div className="flex-1">
                  <p className="font-medium text-red-800 text-sm sm:text-base mb-1">Analysis Error</p>
          ...
          {/* Bottom Quote */}
          <div className="text-center mt-12 sm:mt-16 p-6 sm:p-8 bg-blue-50 border border-blue-200 rounded-2xl sm:rounded-3xl">
            <p className="text-lg sm:text-2xl text-gray-800 italic mb-3 sm:mb-4 leading-relaxed">
              "The difference between the almost right word and the right word is really a large matter—it's the difference between the lightning bug and the lightning."
            </p>
            <p className="text-gray-700 text-sm sm:text-base">— Mark Twain</p>
            <p className="text-xs sm:text-sm text-gray-600 mt-3 sm:mt-4">Let AI help you find the right words for your resume</p>
          </div>
        </div>
      </main>

      {/* Footer */}
      <footer className="bg-gray-50 border-t border-gray-300 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8 sm:mb-12">
            {/* Brand */}
            <div>
              <div className="flex items-center gap-3 mb-4 sm:mb-6">
                <div className="p-2 bg-gradient-to-br from-blue-800 via-blue-700 to-blue-900 rounded-lg">
                  <Brain className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div>
                  <h2 className="text-lg sm:text-xl font-bold text-gray-900">SkillScan<span className="text-blue-700">AI</span></h2>
                  <p className="text-xs sm:text-sm text-gray-600">Intelligent Resume Analyzer</p>
                </div>
              </div>
            ...
            {/* Contact */}
            <div>
              <h3 className="font-semibold text-gray-900 text-base sm:text-lg mb-3 sm:mb-4">Contact Us</h3>
